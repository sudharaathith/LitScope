...
function NavBar(props) {
    ...
    return (
        <div className=' shadow-md w-full fixed top-0 left-0'>
           <div className='md:flex items-center justify-between bg-slate-800 py-4 md:px-10 px-7 text-white'>
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-slate-900 md:bg-slate-800 md:z-auto z-[-1] w-full left-0
